class BreakfastDecoratorTestDrive {
    public static void main(String[] args) {
        Bread bagel = new Bagel();

        bagel = new Butter(bagel);
        bagel = new Butter(bagel);
        bagel = new Hams(bagel);
        bagel = new Cheeses(bagel);
...
abstract class BreakfastDecorator extends Bread {
    abstract String getDescription();
    abstract int getKcal();
}

class Butter extends BreakfastDecorator {
    private Bread bread;
...
class Jam extends BreakfastDecorator {
...
class Cheeses extends BreakfastDecorator {
...
class Hams extends BreakfastDecorator {
